        ...
        <section className="section-1 h-screen px-6 md:px-12 flex flex-col md:flex-row justify-center items-center gap-8 pt-12 sm:pt-16">
          <div className="left w-full md:w-[60%] px-6 text-xl flex flex-col gap-6">
            ...
            <h2 className="text-lg sm:text-xl">
              ...
              <span className="text-purple-500 font-semibold">Full Stack Web Development</span>{" "}
              on <span className="text-green-400">Geekster</span>. I have completed{" "}
              <span className="text-purple-500 font-semibold">B.Pharm</span> from A-One Pharmacy College in 2021.
            </h2>

            <h2 className="text-lg sm:text-xl">
              <span className="text-purple-500">Apart</span> from coding, some other <span className="text-purple-500">activities</span> that I love to do!
            </h2>
          ...
          <div className="right w-full md:w-[30%] flex justify-center">
            <img
              src="/logo.webp"
              alt="About Chirag Tank"
              className="w-2/3 sm:w-[250px] md:w-[200px] object-contain bg-white rounded-2xl"
            />
          </div>
        </section>
