      ...
      <main className="text-white">
        ...
        <section className="section-1 h-screen px-6 md:px-12 flex flex-col md:flex-row justify-center items-center gap-8">
          <div className="left w-full md:w-[60%] px-6 text-xl flex flex-col gap-6">
            ...
            <h2>
              Hi Everyone, I am{" "}
              <span className="text-purple-500 font-semibold">Chirag Tank</span>{" "}
              from Gujarat, India. I am currently pursuing{" "}
          ...
          <div className="right w-full md:w-[35%]">
            <img src="/about-page-main-image.png" alt="About Chirag Tank" className="w-full object-contain" />
          </div>
        </section>
        ...
        <section className="section-2 py-12 flex flex-col gap-12 items-center">
          ...
          <div className="skills px-8 flex flex-wrap justify-center items-center gap-8 text-6xl">
            {[FaJava, RiJavascriptFill, FaHtml5, FaCss3Alt, RiTailwindCssFill, RiReactjsLine, FaNode, SiMongodb, FaGitAlt].map((Icon, i) => (
              <div
                key={i}
                className="skill w-[150px] h-[100px] md:w-[180px] md:h-[120px] rounded-md border-2 border-indigo-500 shadow-lg shadow-indigo-500/50 flex justify-center items-center hover:scale-110 transition-all duration-200"
              >
        ...
        <section className="section-3 py-12 flex flex-col gap-12 items-center">
          ...
          <div className="tools px-8 flex flex-wrap justify-center items-center gap-8 text-6xl">
            {[VscVscode, SiIntellijidea, SiPostman, IoLogoVercel, FaSlack, FaGithub].map((Icon, i) => (
              <div
                key={i}
                className="tool w-[150px] h-[100px] md:w-[180px] md:h-[120px] rounded-md border-2 border-indigo-500 shadow-lg shadow-indigo-500/50 flex justify-center items-center hover:scale-110 transition-all duration-200"
              >
                <Icon className="text-purple-500" />
              </div>
            ))}
